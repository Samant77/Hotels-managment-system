                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="circle-img">
                                                        @if ($roomImage)
                                                            <img src="{{ asset('public/Cms/Roomimage') }}/{{ $roomImage->images }}" width="50" height="50" alt="Room Image">
                                                        @else
                                                            N/A
                                                        @endif
                                                    </div>
                                               ...
                                               <td class="status-toggle" data-room-id="{{ $room->id }}" data-status="{{ $room->status }}">
                                                @if ($room->status == 1)
                                                    <img src="{{ asset('public/images/on.png') }}"  style="width: 50px; height: 50px;">
                                                @else
                                                    <img src="{{ asset('public/images/off.png') }}"  style="width: 50px; height: 50px;">
                                                @endif
                                            </td>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.status-toggle', function () {
            ...
            $.ajax({
                url: '{{url('change-room-status')}}/' + roomId,
                type: 'POST',
                data: {
                    _token: csrfToken,
                    _method: 'PUT',
