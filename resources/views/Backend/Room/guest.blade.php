                                            ...
                                            <td>
                                                ...
                                                <div style="width: 50px; height: 50px; overflow: hidden; border-radius: 50%; margin: auto; text-align: center; line-height: 50px;">
                                                    ...
                                                    @elseif($profilePicture && !$isGoogleProfile)
                                                        <img src="{{ asset('public/Cms/Roomimage/' . basename($profilePicture)) }}" alt="{{ $guest->name }}'s Profile Picture" class="profile-picture rounded-circle img-thumbnail" style="width: 100%; height: auto;">
                                                    @else
                                                        N/A
                                                    @endif
                                                </div>
