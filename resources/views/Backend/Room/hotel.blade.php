                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img src="{{ asset('public/'.$hotel->images->first()->image_path) }}" alt="Hotel Image" style="width: 50px; height: 50px; border-radius: 50%;">
                                                @else
                                                    No Image Available
                                                @endif
                                            </td>
                                            ...
                                            <td class="status-cell" data-hotel-id="{{ $hotel->id }}" data-current-status="{{ $hotel->status }}">
                                                @if($hotel->status == 1)
                                                    <img src="{{asset('public/images/on.png') }}" alt="Active" style="width: 50px; height: 50px;">
                                                @else
                                                    <img src="{{asset('public/images/off.png') }}" alt="Inactive" style="width: 50px; height: 50px;">
                                                @endif
                                            </td>
...
<td>
    ...
    $('.status-cell').on('click', function() {
        ...
        $.ajax({
            url: '{{url('toggle-hotel-status')}}/' + hotelId,
            type: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
