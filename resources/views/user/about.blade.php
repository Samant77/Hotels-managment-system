...
<div class="about" id="about2" style="background: url('{{ asset('public/user/img/pic/abt.png') }}');background-repeat: no-repeat; background-size: cover; height: 60vh; align-items: center;">
			...
			<div class="row mx-auto mt-3">
				...
				<div class="col-lg-4 col-md-4 col-sm-12 text-center">
					<div class="mx-auto " style="margin-top:10vh;" id="about">
						<img src="{{ asset('public/img/pic/abt1.png')}}" >
					</div>
				</div>
			</div>
		...
		<div class="row mx-auto mt-4">
			<div class="col-lg-6 col-md-6 col-sm-12">
				<div class="text-center">
					<img src="{{asset('public/img/pic/a3.png')}}" width="100%" height="100%">
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-12">
		...
		<div class="row text-center  mt-4">
			<div class="col-lg-2 col-md-2 col-sm-12">
				<div class="box-circle mx-auto mt-2">
					<img src="{{asset('public/img/icon/UsersThree.png')}}">
				</div>
			...
			<div class="col-lg-3 col-md-2 col-sm-12">
				<div class="box-circle mx-auto mt-2">
					<img src="{{ asset('public/user/img/icon/user 2.png')}}">
				</div>
			...
			<div class="col-lg-2 col-md-2 col-sm-12">
				<div class="box-circle mx-auto mt-2">
					<img src="{{ asset('public/user/img/icon/Smiley.png')}}">
				</div>
				<div class="mt-2 mx-auto">
			...
			<div class="col-lg-3 col-md-2 col-sm-12">
				<div class="box-circle mx-auto mt-2">
					<img src="{{ asset('public/user/img/icon/Bed.png')}}">
				</div>
				<div class="mt-2 mx-auto">
			...
			<div class="col-lg-2 col-md-2 col-sm-12">
				<div class="box-circle mx-auto mt-2">
					<img src="{{ asset('public/user/img/icon/customer service.png')}}">
				</div>
				<div class="mt-2 mx-auto">
...
<div class="container mt-5">
   ...
   <div class="owl-carousel owl-theme mt-5">
    <div class="item">
    	<img src="{{ asset('public/user/img/pic/lea.png')}}" >
    </div>
    <div class="item">
        <img src="{{ asset('public/user/img/pic/lea1.png')}}" >
    </div>
    <div class="item">
    	<img src="{{ asset('public/user/img/pic/lea2.png')}}" >
    </div>
    <div class="item">
        <img src="{{ asset('public/user/img/pic/lea3.png')}}" >
    </div>
    <div class="item">
        <img src="{{ asset('public/user/img/pic/lea4.png')}}" >
    </div>
