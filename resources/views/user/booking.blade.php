							...
							<div class="row col-12 d-flex justify-content-center">
								<div class="col-lg-4 col-md-4 col-sm-12">
									<div class="text-center mt-2" style="width: 100px; height: 100px; overflow: hidden; border-radius: 10px;">
                                        <img src="{{ asset('public/user/img/icon/pro1.png') }}" alt="" style="width: 100%; height: 100%; object-fit: cover;">
                                    </div>
                                ...
                                <div class="mt-4 d-inline d-flex">
                                	<img src="{{asset('public/user/img/icon/star-shape.png')}}" class="ms-0">
                                	<img src="{{asset('public/user/img/icon/star-shape.png')}}" class="ms-3">
                                	<img src="{{asset('public/user/img/icon/star-shape.png')}}" class="ms-3">
                                	<img src="{{asset('public/user/img/icon/star-shape.png')}}" class="ms-3">
                                	<img src="{{asset('public/user/img/icon/star-shape.png')}}" class="ms-3">
                                </div>
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							...
							<a class="navbar-brand" href="#" style="font-size:15px;">
                               ...
                               <div style="list-style: none;" class="mt-2">
                                ...
                                <li><span class="text-muted">Transaction ID:</span>{{$booking->payment_id}}</li>
