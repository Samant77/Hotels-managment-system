		...
		<div class="row col-12 d-flex align-items-center">
			<div class="col-lg-2 col-md-3 col-sm-12 my-auto" style="align-items: center;" id="se">
				...
				<div class="my-2" style="height: 23%; width: 95%; overflow: hidden; border-radius: 15px;">
                    <img src="{{ asset('public/'.$image->image_path) }}" style="width: 100%; height: 100%; object-fit: cover;">
                </div>
                {{-- <div class=" my-2" style="height:15%;width: 95%;">
					<img src="{{asset('public/user/img/pic/m3.png')}}" style="width:100%;height:100%;">
				</div>
				<div class="my-2" style="height:15%;width: 95%;">
					<img src="{{asset('public/user/img/pic/m4.png')}}" style="width:100%;height:100%;">
				</div>
				<div class="my-2" style="height:15%;width: 95%;">
					<img src="{{asset('public/user/img/pic/m5.png')}}" style="width:100%;height:100%;">
				</div> --}}
                @endforeach
			</div>
				...
				<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item @if($key === 0) active @endif" style="height: 100%;">
                            <img src="{{ asset('public/'.$item->image_path) }}" class="d-block w-100" alt="..." style="height: 100%;">
...
<div class="container-flui p-5 mt-3">
  ...
  <div class="d-flex align-items-center">
    <div class="">
      <img src="{{asset('public/user/img/icon/star-shape.png')}}">
    </div>
    <div class=" ms-2">
        <img src="{{asset('public/user/img/icon/star-shape.png')}}">
    </div>
 ...
 <div class="d-flex justify-content-arround">
   	...
   	<div class="d-flex justify-content-center">
          ...
          <h2>Reviews & Feedback</h2>
            ...
            <div class="d-flex align-items-center">
              ...
              <button type="button" class="btn " style="background-color:#FE3400; color:white;font-size: 20px;">4.5  <img src="{{asset('public/user/img/pic/Star.png')}}"></button>
            </div>
            </div>
  ...
  <div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
   ...
   <div class="container-fluid p-4 mx-auto">
     <div class="d-flex align-items-center">
       <div>
         <img src="{{asset('public/user/img/icon/avatar.png')}}" height="70vh" alt="">
       </div>
     ...
     <div class="d-flex align-items-center">
       <div>
         <img src="{{asset('public/user/img/icon/avatar.png')}}" height="70vh" alt="">
            ...
            <div class="ms-1">
                <img src="{{asset('public/user/img/icon/star-shape.png')}}"style="opacity:0.3">
            </div>
       ...
       @foreach($roomTypes as $roomType)
           ...
           <div class="col-lg-4 col-md-4 col-sm-12">
               <div class="card border-0 mt-4">
                ...
                <img src="{{ asset('public/Cms/Roomimage/' . $roomType->roomImages->first()->images) }}" alt="best-service" class="rounded-square-img"></a>
    ...
    {{-- <a class="navbar-brand " href="#" style="font-size:21px;">
      ...
      <i class="fa fa-map-marker" aria-hidden="true"></i> Lucknow</a> --}}
         ...
         <div class="d-flex align-items-center mt-3">
             <div>
                 <h6><span class="p-1" id="hom" style="background: linear-gradient(180deg, #FE9000 0%, #FF3500 100%);width: 30%;border-radius:6px;color: white;"> 4.2 <img src="{{asset('public/user/img/pic/Star.png')}}"></span></h6>
             </div>
