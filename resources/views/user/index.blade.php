...
@section('main-container')
 ...
 <div class="container p-5 ">
    <form method="POST" action="{{url('avail')}}"> <!-- Add your route for form submission -->
        @csrf <!-- Add CSRF token for security -->
        <div class="btn-group">
            <button class="btn text-white shd-bg px-4 rounded py-2 fs-5" id="btn-status1">
                <img src="{{ asset('public/user/img/icon/Hotel.png')}}" class="me-2">Hotel
            </button>
        </div>
        <!-- first Tab-->
            ...
            <div class="row col-12">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-12">
                    <button type="submit" class="btn btn-lg text-white mt-2" style="background-color:#FE3400;">
                        <img src="{{('public/user/img/icon/MagnifyingGlass.png')}}"> Search
                    </button>
                </div>
            </div>
            <!-- End of form content -->
   ...
   {{-- <div class="container-fluid p-4 rounded text-center" style=" display:none; background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0,0,0,0.5)) " id="status2">
      <div class="row col-12">
          ...
          <button class="btn btn-lg text-white mt-2" style="background-color:#d13F21;">
           <img src="{{ asset('public/public/user/img/icon/MagnifyingGlass.png')}}"> Find
          </button>
          </div>
      </div>
   </div> --}}
               ...
               <div class="card border-0 mt-5">
                <div class="image-container rounded-square">
                    <a href="{{ route('hotel.singal', ['id' => $hotel->id]) }}">
                        <img src="{{ asset('public/'.$hotel->images->first()->image_path) }}" class="equal-size" alt="best-service">
                    </a>
                    </div>
    ...
    <div class="container-fluid p-3">
     ...
     <p>Daily Adventures, Daily Savings</p>
           ...
           <div class="col-lg-4 col-md-4 col-sm-12">
             ...
             <img src="{{ asset('public/user/img/pic/a3.png')}} " style="width:100% height:100%;"alt="best-service">
             <div class="" id="slide">
         ...
         <div class="mt-2">
           ...
           <div class="col-lg-4 col-md-4 col-sm-12">
               <div class="card border-0 mt-4">
             <img src="{{ asset('public/user/img/pic/a1.png')}} " style="width:100% height:100%;"alt="best-service">
             <div class="" id="slide">
                <span class="heart bg-light p-2" style="border-radius:50%;"><i class="fa fa-heart-o rounded-circle bg-light p-1" aria-hidden="true"></i></span>
            </div>
         ...
         <div class="mt-2">
           ...
           <div class="col-lg-4 col-md-4 col-sm-12">
               <div class="card border-0 mt-4">
             <img src="{{ asset('public/user/img/pic/a2.png')}} "  style="width:100% height:100%;"alt="best-service">
             <div class="" id="slide">
                <span class="heart bg-light p-2" style="border-radius:50%;"><i class="fa fa-heart-o rounded-circle bg-light p-1" aria-hidden="true"></i></span>
            </div>
...
<div class="container-fluid p-5 mt-5" style="background: #0B214C;">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 text-white">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <img src="{{ asset('public/user/img/pic/Star.png')}}">
                            <img src="{{ asset('public/user/img/pic/Star.png')}}">
                            <img src="{{ asset('public/user/img/pic/Star.png')}}">
                            <img src="{{ asset('public/user/img/pic/Star.png')}}">
                            <img src="{{ asset('public/user/img/pic/Star.png')}}">
    ...
    <div class="logo-box d-flex flex-wrap  align-items-center">
        <div>
            <img src="{{ asset('public/user/img/pic/Ellipse 2.png')}}"  alt="">
        </div>
        <div class="ms-4">
    ...
    <div class="container p-5 mt-2">
        ...
        <div class="row col-12 text-center">
            <div class="col-lg-4 col-md-4 col-sm-12">
                <img src="{{ asset('public/user/img/icon/Group 2608635.png')}}">
                <div class="mt-3">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <img src="{{ asset('public/user/img/icon/Group 2608636.png')}}">
                <div class="mt-3">
                <h6>Best Price Guarantee</h6>
                <p style="font-size:14px;">Best Recommendations according to your Interest</p>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <img src="{{ asset('public/user/img/icon/Group 2608634.png')}}">
                <div class="mt-3">
                <h6>Best Price Guarantee</h6>
                <p style="font-size:14px;">Best Recommendations according to your Interest</p>
                  </div>
    ...
    <h3 style="font-size:30px;font-weight: bold;">Get Inspiration for your Next Trip</h3>
        <p>Find Inspirations here</p>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 mt-2">
                <img src="{{asset('public/user/img/pic/p6.png')}}" style="width:100%;height:auto;" class="text-center">
                <div class="mt-2 p-2">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 mt-2">
                <img src="{{asset('public/user/img/pic/p8.png')}}" style="border-radius:12px;width:100%;height:auto;" class="text-center">
                <div class="mt-2 p-2">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 mt-2">
                <img src="{{asset('public/user/img/pic/p7.png')}}" style="width:100%;height:auto;" class="text-center">
                <div class="mt-2 p-2">
...
function toggleWishlist(hotelId) {
    $.ajax({
        url: '{{url('wishlist/add')}}', // Replace with your route for adding/removing from wishlist
        type: 'POST',
        data: {
            hotel_id: hotelId,
            _token: '{{ csrf_token() }}'
