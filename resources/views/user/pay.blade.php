...
<div class="card p-3 mx-auto">
    <div class="row ">
        <div class="col-lg-3 col-md-4 col-sm-12 mt-3">
            ...
            <img src="{{asset('public/user/img/pic/p1.png')}}" width="100%" height="100%">
           </div>
        </div>
            ...
            <label for="creditCard">
                <div class="mt-1">
                    <a class="navbar-brand text-muted" href="#" style="font-size:18px;font-weight: 500;">
                        <img src="{{asset('public/user/img/icon/image 7.png')}}"> Credit Card</a>
                </div>
            </label>
        </div> --}}
    ...
    <div class="row mt-2">
        <div class="col-lg-3 col-md-2">
            ...
            <label for="online">
                <div class="mt-1">
                    <a class="navbar-brand text-muted" href="#" style="font-size:18px;font-weight: 500;">
                        <img src="{{asset('public/user/img/icon/image 7.png')}}"> Online</a>
                </div>
            </label>
        </div>
        <div class="col-lg-9 col-md-10 my-2">
    ...
    <div class="row mt-2">
        ...
        <div class="col-lg-3 col-md-2">
            ...
            <label for="cashOnArrival">
                <div class="mt-1">
                    <a class="navbar-brand text-muted" href="#" style="font-size:18px;font-weight: 500;">
                        <img src="{{asset('public/user/img/icon/image 7.png')}}"> Cash on Arrival</a>
                </div>
            </label>
        </div>
        <div class="col-lg-9 col-md-10 my-2">
