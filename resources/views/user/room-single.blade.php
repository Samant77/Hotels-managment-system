				...
				<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" style="width: 100%; height: 300px; overflow: hidden;">
					<div class="carousel-inner" style="width: 100%; height: 100%;">
						...
						<div class="carousel-item {{ $key === 0 ? 'active' : '' }}" data-bs-interval="2000" style="width: 600px; height: 400px;">
							<img src="{{ asset('public/Cms/Roomimage/' . $roomimage->images) }}" class="d-block w-100 h-100 rounded-square" alt="Room Image" style="object-fit: cover; border-radius: 12px;">
						</div>
						@endforeach
					</div>
...
<script>
    $(document).ready(function() {
        $('#checkAvailabilityBtn').click(function() {
            ...
            $.ajax({
                type: 'POST',
                url: '{{url('check-availability')}}', // Replace with your route endpoint
                data: {
                    '_token': '{{ csrf_token() }}',
