...
Route::get('/',[App\Http\Controllers\website\WebsiteController::class,'index']);
Route::get('index',[App\Http\Controllers\website\WebsiteController::class,'index']);
...
Route::get('/hotels', [\App\Http\Controllers\website\WebsiteController::class,'hotelsviewd']);
...
Route::group(['middleware' => ['loginCheck']], function () {
    ...
    Route::get('/guest_bookings',[App\Http\Controllers\Backend\RoomController::class, 'bookings'])->name('guest_book');
    //room DETAILS START
